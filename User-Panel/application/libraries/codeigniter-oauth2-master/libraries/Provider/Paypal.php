...
class OAuth2_Provider_Paypal extends OAuth2_Provider
{
     ...
     */
    protected $scope = array('https://www.sandbox.paypal.com/webapps/auth/protocol/openidconnect/v1/userinfo');
    ...
    {
        return 'https://www.sandbox.paypal.com/webapps/auth/protocol/openidconnect/v1/tokenservice';
    }

    public function get_user_info(OAuth2_Token_Access $token)
    {
        $url = 'https://www.sandbox.paypal.com/webapps/auth/protocol/openidconnect/v1/userinfo?' . http_build_query(array(
