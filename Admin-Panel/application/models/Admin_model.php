...
class Admin_model extends CI_Model {
        ...
        public function adminLogin($postData) {
        	...
        	$salt = $this->generateSalt();
        	$email = $this->db->escape(strip_tags($postData["username"]));
...
//        		$sql = "SELECT * FROM admin WHERE id = ".$this->db->escape(strip_tags((int)$this->session->userdata("admin_id")))." AND verification_key = ".$this->db->escape(strip_tags($this->session->userdata("verification_key")));
